...
export function AppSidebar() {
    return (
        <Sidebar
            collapsible="icon"
            variant="inset"
            className="border-r-4 border-r-gray-900 bg-[#FFFDF4]"
        >
            {/* ─── HEADER ─── */}
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton
                            size="lg"
                            asChild
                            className="h-11 rounded-lg border-3 border-gray-900 bg-white shadow-md transition-all hover:-translate-y-0.5 hover:shadow-lg"
                        >
