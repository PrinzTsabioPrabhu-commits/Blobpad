                ...
                <form onSubmit={doSearch} className="flex gap-3">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border-4 border-gray-900 bg-white py-4 pr-4 pl-12 text-base font-bold text-gray-900 placeholder-gray-400 shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all outline-none focus:translate-y-1 focus:shadow-[0px_0px_0px_rgba(0,0,0,1)]"
                        />
                        {query && (
                            <button
                                type="button"
                                ...
                                className="absolute top-1/2 right-4 -translate-y-1/2 text-gray-400 hover:text-gray-900"
                            >
                    ...
                    <button
                        type="submit"
                        className="rounded-xl border-4 border-gray-900 bg-blue-500 px-6 py-4 text-sm font-bold text-white shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all hover:translate-y-1 hover:shadow-[0px_0px_0px_rgba(0,0,0,1)]"
                    >
                        Cari
                    </button>
                </form>
                        ...
                        {results.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-16 text-gray-500">
                                ...
                                <p className="font-bold">
                                    Tidak ditemukan catatan dengan kata kunci "
                                    {initialQuery}"
                                </p>
                            </div>
                        ) : (
                            <div className="flex flex-col gap-3">
                                {results.map((note) => (
                                    <Link
                                        ...
                                        className="group flex items-center gap-4 rounded-2xl border-4 border-gray-900 bg-white p-5 shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all hover:-translate-y-1 hover:shadow-[6px_6px_0px_rgba(0,0,0,1)]"
                                    >
