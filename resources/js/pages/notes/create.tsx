                ...
                >
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border-4 border-gray-900 bg-white p-4 text-lg font-bold text-gray-900 placeholder-gray-400 shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all outline-none focus:translate-y-1 focus:shadow-[0px_0px_0px_rgba(0,0,0,1)]"
                        />
                        {errors.title && (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={12}
                            className="w-full rounded-xl border-4 border-gray-900 bg-white p-4 text-base font-medium text-gray-900 placeholder-gray-400 shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all outline-none focus:translate-y-1 focus:shadow-[0px_0px_0px_rgba(0,0,0,1)]"
                        />
                    </div>
